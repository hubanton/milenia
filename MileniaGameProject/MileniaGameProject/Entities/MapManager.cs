    ...
    public class MapManager : IGameEntity
    {
        ...
        public void LoadMap(String map, Character character, List<(Rectangle, String)> entryPoints, Vector2 cameraPosition)
        {
            ...
            else if (Map.MapTexture.Name == "TownMap")
            {
                ...
                Milenia.BuildingManager.SpawnBuilding("houses/Blacksmith", Map, new Vector2(5253, 1280), smithBounds, Rectangle.Empty);
                List<Rectangle> shopkeeperBounds = new List<Rectangle>();
                shopkeeperBounds.Add(new Rectangle(44, 200, 916, 272));
                Milenia.BuildingManager.SpawnBuilding("houses/ShopkeeperHouse", Map, new Vector2(3785, 2748), shopkeeperBounds, Rectangle.Empty);
                ...
                Milenia.BuildingManager.SpawnBuilding("houses/Bakery", Map, new Vector2(1814, 3020), bakeryBounds, Rectangle.Empty);
                ...
                Milenia.BuildingManager.SpawnBuilding("houses/ThiefHouse", Map, new Vector2(43, 2808), thiefHouseBounds, Rectangle.Empty);
                List<Rectangle> churchBounds = new List<Rectangle>();
                churchBounds.Add(new Rectangle(40, 1200, 1000, 784));
                Milenia.BuildingManager.SpawnBuilding("houses/Church", Map, new Vector2(1323, 4), churchBounds, Rectangle.Empty);
                ...
                Milenia.BuildingManager.SpawnBuilding("houses/Harlequin", Map, new Vector2(58, 726), harlequinHouseBounds, Rectangle.Empty);
                List<Rectangle> oracleHouseBounds = new List<Rectangle>();
                oracleHouseBounds.Add(new Rectangle(75, 240, 729, 268));
                Milenia.BuildingManager.SpawnBuilding("houses/OracleHouse", Map, new Vector2(44, 47), oracleHouseBounds, Rectangle.Empty);
                List<Rectangle> fanaticOneBounds = new List<Rectangle>();
                fanaticOneBounds.Add(new Rectangle(60, 320, 393, 216));
                Milenia.BuildingManager.SpawnBuilding("houses/FanaticHouse", Map, new Vector2(4230, 125), fanaticOneBounds, Rectangle.Empty);
                List<Rectangle> fanaticTwoBounds = new List<Rectangle>();
                fanaticTwoBounds.Add(new Rectangle(60, 320, 393, 216));
                Milenia.BuildingManager.SpawnBuilding("houses/FanaticHouse", Map, new Vector2(4230, 725), fanaticTwoBounds, Rectangle.Empty);
                List<Rectangle> fanaticThreeBounds = new List<Rectangle>();
                fanaticThreeBounds.Add(new Rectangle(60, 320, 393, 216));
                Milenia.BuildingManager.SpawnBuilding("houses/FanaticHouse", Map, new Vector2(4230, 1325), fanaticThreeBounds, Rectangle.Empty);
            }
